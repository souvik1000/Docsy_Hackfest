...
from UITesting.controller.pageobject.pages.landingpage import LandingPage
from UITesting.controller.pageobject.locator.varpatientsignup import VarPatientSignUp
