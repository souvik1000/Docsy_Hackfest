...
import time
from UITesting.patient.pageobject.pages.patienthomepage import PatientHomePage
from UITesting.patient.pageobject.pages.appointmentpage import AppointmentPage
