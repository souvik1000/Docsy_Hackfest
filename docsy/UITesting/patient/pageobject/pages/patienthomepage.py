...
import time
from UITesting.patient.pageobject.locator.get import GetPage
from UITesting.patient.pageobject.locator.varpatienthomepage import VarPatientHomePage
from UITesting.receptionist.pageobject.locators.varviewmedicaldata import VarViewMedicalData
from UITesting.patient.pageobject.pages.patientlogin import PatientLogin
...
class PatientHomePage:
    ...
    def viewprescription(self,driver):
        ...
        for i in range(1,2):
            ...
            MedicineNameExpected=VarPatientHomePage.MEDICINE_NAME_EXPECTED.format(str(i))
            ...
            FormExpected=VarPatientHomePage.FORM_VALUE_EXPECTED.format(str(i))
            ...
            StrengthExpected=VarPatientHomePage.STRENGTH_VALUE_EXPECTED.format(str(i))
            ...
            StrengthUnitExpected=VarPatientHomePage.STRENGTH_UNIT_VALUE_EXPECTED.format(str(i))
            ...
            DiluentExpected=VarPatientHomePage.DILUENT_VALUE_EXPECTED.format(str(i))
            ...
            DiluentAmountExpected=VarPatientHomePage.DILUENT_AMOUNT_VALUE_EXPECTED.format(str(i))
            ...
            DiluentUnitExpected=VarPatientHomePage.DILUENT_UNIT_VALUE_EXPECTED.format(str(i))
            ...
            DosageDirectionsExpected=VarPatientHomePage.DOSAGE_DIRECTIONS_VALUE_EXPECTED.format(str(i))
            ...
            FrequencyExpected=VarPatientHomePage.FORM_VALUE_EXPECTED.format(str(i))
            ...
            FrequencyUnitExpected=VarPatientHomePage.FREQUENCY_UNIT_VALUE_EXPECTED.format(str(i))
            ...
            IntervalExpected=VarPatientHomePage.INTERVAL_VALUE_EXPECTED.format(str(i))
            ...
            IntervalUnitExpected=VarPatientHomePage.INTERVAL_UNIT_VALUE_EXPECTED.format(str(i))
            ...
            NamedEventExpected=VarPatientHomePage.NAMED_TIME_EVENT_VALUE_EXPECTED.format(str(i))
            ...
            ExactTimingExpected=VarPatientHomePage.EXACT_TIMING_CRITICAL_VALUE_EXPECTED.format(str(i))
